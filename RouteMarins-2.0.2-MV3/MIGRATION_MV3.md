...
Cette version 2.0.2 porte RouteMarins de Manifest V2 vers Manifest V3.
...
- L'identifiant de course utilisé par les liens vers les polaires est résolu dynamiquement depuis `races2.json` en fonction du chemin de la page Zezo.
