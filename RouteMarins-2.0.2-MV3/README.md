...
L'identifiant de course des liens vers les polaires est récupéré dynamiquement depuis la liste des courses Zezo, avec repli sur les anciennes correspondances intégrées si cette liste est temporairement indisponible.
